...
// LinearElasticCTB 2Dlxd
static Register<mpm::Material<2>, mpm::LinearElasticCTB<2>, unsigned, const Json&>
    linear_elastic_ctb_2d("LinearElasticCTB2D");

// LinearElasticCTB 3Dlxd
static Register<mpm::Material<3>, mpm::LinearElasticCTB<3>, unsigned, const Json&>
    linear_elastic_ctb_3d("LinearElasticCTB3D");
